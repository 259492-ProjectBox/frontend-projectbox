	...
	return (
		<>
			<div className="h-screen w-full flex justify-center items-center bg-gradient-to-r from-blue-500 to-teal-500">
				<div className="flex flex-col md:flex-row bg-white p-8 rounded-lg shadow-lg w-11/12 md:w-2/3 lg:w-1/2">
					...
					<div className="flex flex-col justify-center items-center md:w-1/2">
						...
						<a href={process.env.NEXT_PUBLIC_CMU_OAUTH_URL}>
							<button className="bg-blue-600 text-white py-2 px-6 rounded-lg shadow hover:bg-blue-700 transition duration-300 flex justify-center items-center gap-2">
								<Image
